...
// Tidak perlu mengimplementasikan MustVerifyEmail kecuali Anda benar-benar memiliki
// alur verifikasi email untuk pendaftaran non-Google.
...
class User extends Authenticatable
{
    ...
    protected static function booted(): void
    {
        ...
        static::creating(function ($user) {
            // Jika id_user belum diisi (misalnya saat pendaftaran manual atau via Google pertama kali),
            // maka buat ID baru.
            if (empty($user->id_user)) {
                // Format: 'CUS' + Tahun (2 digit) + Bulan + 4 angka acak
                // Contoh: CUS25061234 (untuk customer yang dibuat Juni 2025)
                $user->id_user = 'CUS' . date('ym') . mt_rand(1000, 9999);
            }
        });
    }
