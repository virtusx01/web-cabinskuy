...
return new class extends Migration
{
    ...
    {
        Schema::create('payments', function (Blueprint $table) { // Menggunakan 'payments' sebagai nama tabel (plural)
    ...
    {
        Schema::dropIfExists('payments'); // PERBAIKAN: Drop 'payments' bukan 'payment'
    }
};