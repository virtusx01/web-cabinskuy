...
{{-- Set judul halaman --}}
@section('title', 'Reset Password - Cabinskuy')
...
@section('content')
    <div class="main-content">
        <div class="form-container">
            ...
            {{-- Menggunakan route `password.email` yang biasanya terhubung ke `sendResetLinkEmail` --}}
            <form action="{{ route('password.email') }}" method="post" id="resetForm">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}"
                        class="form-control @error('email') is-invalid @enderror" placeholder="Masukkan email Anda di sini" required autofocus>
                    @error('email')
                ...
                <div class="form-group">
                    <button type="submit" class="btn-submit" id="submitBtn">Kirim Tautan Reset Password</button>
                </div>
            </form>

            <div class="footer-link">
                Ingat kata sandi Anda? <a href="{{ route('backend.login') }}">Login di sini</a>
            </div>
        </div>
    </div>
@endsection