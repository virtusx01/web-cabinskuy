        ...
        <div class="form-container">
            <div class="form-header">
                ...
                <div class="title-container">
                    ...
                    <p>Your amazing staycation will begin here</p>
                </div>
            </div>
            ...
            <form action="{{ route('backend.login') }}" method="post" id="loginForm">
                ...
                <div class="form-group">
                    <div class="label-group">
                        ...
                        {{-- Removed "Use Phone Number?" link --}}
                    </div>
                    <input type="email" name="email" id="email" value="{{old('email')}}"
                        class="form-control @error('email') is-invalid @enderror" placeholder="Input your email here" required>
                    @error('email')
            ...
            <div class="footer-link">
                Not a Cabinskuy member yet? <a href="{{ route('backend.register') }}">Create account</a>
            </div>
        </div>
    </main>
@endsection
...
@push('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const alerts = document.querySelectorAll('.alert-session-error');
